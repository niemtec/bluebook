...
Managing your knowledge portfolio effectively:
...
**Diversify**: the more *different* things you know, the more valuable you are. Don't stop at your current technology, the more you are comfortable with, the better you will be able to adjust to change. (Don't forget the *other* skills you need, including those in non-technical areas)
...
**Read nontechnical books too**: computers are used by *people* — people whose needs you are trying to satisfy. You work with people, are employed by people, and get hacked by people. *Don't forget the human side of the equation, as that requires an entirely different skillset.*
...
**Who does this benefit?**: *follow the money*, it might be a helpful path to analyse. The benefits to someone else or another organisation may be aligned with your own (or not!)
...
There's one way you must use if you want people to listen to you: *listen to them*. Even in a situation where you have all the information, if you don't listen to them, they won't listen to you.
...
- Engineers keep notebooks. They've been trained to keep a *daybook*, a kind of journal in which they record what they do, things they've learned, sketches of ideas, readings... basically anything to do with their work.
